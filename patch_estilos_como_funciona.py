...
old = '''        .sec-desc { margin: 10px 0; max-width: 480px; font-size: 14px; line-height: 1.6; color: rgba(255,255,255,0.6); }'''

new = '''        .sec-desc { margin: 10px 0; max-width: 480px; font-size: 14px; line-height: 1.6; color: rgba(255,255,255,0.6); }
