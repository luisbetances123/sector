...
export default function PropertyDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#0a0a0a', color: '#fff', fontFamily: 'system-ui, sans-serif' }}>
      <div style={{ position: 'relative', height: '100vh', background: propiedad.imagen ? `url(${propiedad.imagen}) center/cover no-repeat` : 'linear-gradient(135deg,#1a1a2e,#2d2d5e)', display: 'flex', flexDirection: 'column' }}>
        ...
        {!editando ? (
          ...
          <div style={{ background: 'rgba(212,175,55,0.04)', border: '1px solid rgba(212,175,55,0.2)', borderRadius: '16px', padding: '24px', marginBottom: '16px' }}>
            ...
            <div style={{ marginBottom: '14px' }}>
              <label style={{ display: 'block', fontSize: '11px', color: '#888', marginBottom: '5px', textTransform: 'uppercase', letterSpacing: '1px' }}>URL Imagen</label>
              <input value={form.imagen || ''} onChange={e => setForm({ ...form, imagen: e.target.value })} placeholder="https://..." style={{ width: '100%', background: 'rgba(255,255,255,0.05)', border: '1px solid rgba(255,255,255,0.15)', borderRadius: '10px', color: '#fff', padding: '11px 14px', fontSize: '14px', outline: 'none', boxSizing: 'border-box' }} />
            </div>
            <div style={{ marginBottom: '14px' }}>
