    ...
    <div className="p-8 max-w-6xl mx-auto min-h-screen text-zinc-100">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
        <div className="bg-[#18181b] border border-zinc-800 rounded-xl p-5">
          <p className="text-xs text-white uppercase tracking-wider font-mono mb-2">Brokers activos</p>
        ...
        <div className="bg-[#18181b] border border-amber-400/20 rounded-xl p-5">
          <p className="text-xs text-white uppercase tracking-wider font-mono mb-2">Unidades reservadas</p>
        ...
        <div className="bg-[#18181b] border border-red-500/20 rounded-xl p-5">
          <p className="text-xs text-white uppercase tracking-wider font-mono mb-2">Unidades vendidas</p>
        ...
        <div className="bg-[#18181b] border border-[#d4ff3b]/20 rounded-xl p-5">
          <p className="text-xs text-white uppercase tracking-wider font-mono mb-2">Volumen total</p>
      ...
      {brokersFiltrados.length === 0 ? (
        ...
        <div className="bg-[#18181b] border border-zinc-800 rounded-2xl overflow-hidden">
          ...
          <div className="hidden md:grid grid-cols-12 gap-4 px-6 py-3 border-b border-zinc-800 bg-zinc-900/50">
            <p className="col-span-3 text-xs text-white uppercase tracking-wider font-mono">Broker / Agencia</p>
            <p className="col-span-2 text-xs text-white uppercase tracking-wider font-mono">Proyecto</p>
            <p className="col-span-1 text-xs text-white uppercase tracking-wider font-mono text-center">Reservadas</p>
            <p className="col-span-1 text-xs text-white uppercase tracking-wider font-mono text-center">Vendidas</p>
            <p className="col-span-2 text-xs text-white uppercase tracking-wider font-mono text-right">Volumen</p>
            <p className="col-span-1 text-xs text-white uppercase tracking-wider font-mono text-center">Estado</p>
            <p className="col-span-2 text-xs text-white uppercase tracking-wider font-mono text-right">Acciones</p>
          </div>
              ...
              <div key={idx}>
                ...
                >
                  ...
                  <div className="flex items-center justify-between md:col-span-3">
                    ...
                    <span className={`md:hidden text-xs px-2 py-1 rounded-full border font-mono ${b.activo ? 'bg-emerald-500/10 text-emerald-400 border-emerald-500/20' : 'bg-zinc-800 text-zinc-500 border-zinc-700'}`}>
                  ...
                  <div className="md:col-span-2">
                    <p className="text-zinc-400 text-sm truncate">
                      <span className="md:hidden text-zinc-500 font-mono text-xs uppercase mr-1">Proyecto:</span>
                      {b.proyecto_nombre}
                    </p>
                  </div>
                  ...
                  <div className="grid grid-cols-3 gap-2 md:contents">
                    <div className="md:col-span-1 md:text-center">
                      <p className="md:hidden text-xs text-zinc-500 font-mono uppercase mb-0.5">Reservadas</p>
                      <span className={`font-mono font-bold text-sm ${b.unidades_reservadas > 0 ? 'text-amber-400' : 'text-zinc-600'}`}>
                        {b.unidades_reservadas}
                      </span>
                    </div>
                    <div className="md:col-span-1 md:text-center">
                      <p className="md:hidden text-xs text-zinc-500 font-mono uppercase mb-0.5">Vendidas</p>
                      <span className={`font-mono font-bold text-sm ${b.unidades_vendidas > 0 ? 'text-red-400' : 'text-zinc-600'}`}>
                        {b.unidades_vendidas}
                      </span>
                    </div>
                    <div className="md:col-span-2 md:text-right">
                      <p className="md:hidden text-xs text-zinc-500 font-mono uppercase mb-0.5">Volumen</p>
                      ...
                      {b.volumen_reservado > 0 && b.volumen_vendido > 0 && (
                        <p className="text-zinc-400 text-xs font-mono">${b.volumen_reservado.toLocaleString()} reservado</p>
                      )}
                    </div>
                  </div>
                  ...
                  <div className="hidden md:block md:col-span-1 md:text-center">
                    <span className={`text-xs px-2 py-1 rounded-full border font-mono ${b.activo ? 'bg-emerald-500/10 text-emerald-400 border-emerald-500/20' : 'bg-zinc-800 text-zinc-500 border-zinc-700'}`}>
                      {b.activo ? 'Activo' : 'Inactivo'}
                    </span>
                  </div>
                  ...
                  <div className="flex justify-between md:justify-end items-center gap-2 md:col-span-2">
                    ...
                    <div className="flex items-center gap-2">
                      <button
                        ...
                        className="bg-zinc-800 hover:bg-zinc-700 text-white text-xs px-3 py-1.5 rounded-lg transition font-mono"
                      >
                        Copiar link
                      </button>
                      {b.activo && (
                        <button
                          ...
                          className="bg-zinc-900 hover:bg-red-950/40 text-zinc-600 hover:text-red-400 text-xs px-2 py-1.5 rounded-lg transition border border-zinc-800"
                        >
                          ✕
                        </button>
                      )}
                ...
                {expandido === b.token && (b.lista_reservadas.length > 0 || b.lista_vendidas.length > 0) && (
                  <div className="px-6 pb-5 pt-1 bg-zinc-900/50 border-t border-zinc-800/50">
                    {b.lista_reservadas.length > 0 && (
                      <div className="mb-3">
                        <p className="text-xs text-amber-400 font-mono uppercase tracking-wider mb-2">Reservadas:</p>
                    ...
                    {b.lista_vendidas.length > 0 && (
                      <div>
                        <p className="text-xs text-red-400 font-mono uppercase tracking-wider mb-2">Vendidas:</p>
                        <div className="flex flex-wrap gap-2">
