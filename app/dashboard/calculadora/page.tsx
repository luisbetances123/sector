      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="space-y-6">
          <div className="bg-zinc-950 border border-zinc-800 rounded-2xl p-6 space-y-5">
            <h2 className="text-xs font-mono text-zinc-500 uppercase tracking-wider">Parámetros</h2>

            <div>
              <label className="text-[10px] font-mono text-zinc-500 uppercase tracking-wider">Precio de la Propiedad (USD)</label>
            ...
            <div>
              <label className="text-[10px] font-mono text-zinc-500 uppercase tracking-wider">Inicial: {inicial}%</label>
            ...
            <div>
              <label className="text-[10px] font-mono text-zinc-500 uppercase tracking-wider">Plazo: {plazo} años</label>
            ...
            <div>
              <label className="text-[10px] font-mono text-zinc-500 uppercase tracking-wider">Banco / Tasa de Interés</label>
          ...
          <div className="bg-zinc-950 border border-[#CCFF00]/20 rounded-2xl p-6 space-y-5">
            ...
            <div className="grid grid-cols-2 gap-4 pt-4 border-t border-zinc-800">
              <div className="bg-zinc-900 rounded-xl p-4">
                <p className="text-[10px] font-mono text-zinc-500 uppercase">Monto Financiado</p>
                <p className="text-lg font-black text-white mt-1">{fmt(montoFinanciado)}</p>
              </div>
              <div className="bg-zinc-900 rounded-xl p-4">
                <p className="text-[10px] font-mono text-zinc-500 uppercase">Total Intereses</p>
                <p className="text-lg font-black text-red-400 mt-1">{fmt(totalIntereses)}</p>
              </div>
              <div className="bg-zinc-900 rounded-xl p-4">
                <p className="text-[10px] font-mono text-zinc-500 uppercase">Total a Pagar</p>
            ...
            {cuotaMensual > 0 && (
              <div className="bg-zinc-900 rounded-xl p-4 border border-zinc-800">
                <p className="text-[10px] font-mono text-zinc-500 uppercase mb-2">Banco Seleccionado</p>
