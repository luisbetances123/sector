          ...
          {columns.map((col) => (
            <div key={col.id} className="flex flex-col space-y-4 h-full min-h-[650px] bg-zinc-950/20 p-2 rounded-2xl">
              ...
              <div className="space-y-4 flex-1">
                ...
                {col.deals.length === 0 && (
                  <div className="border border-dashed border-zinc-900/40 h-[220px] rounded-2xl flex items-center justify-center text-zinc-800 font-mono text-xs select-none">
                    // VACÍO
                  </div>
                )}
              </div>
