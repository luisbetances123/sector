      ...
      <div className="md:hidden">
        ...
        {leadsSimResponder.length > 0 && (
          <div className="bg-red-950 border border-red-800 rounded-2xl p-4 mb-4">
            ...
            {leadsSimResponder.length > 3 && (
              <Link href="/clients" className="block text-center text-red-400 text-xs mt-2">Ver {leadsSimResponder.length - 3} mas →</Link>
            )}
          </div>
        )}

        {/* SEGUIMIENTOS DE HOY */}
        <div className="bg-amber-950/50 border border-amber-800/50 rounded-2xl p-4 mb-4">
          <div className="flex items-center justify-between mb-3">
            <div className="flex items-center gap-2">
              <span className="text-lg">🟡</span>
              <span className="text-amber-300 font-black text-sm uppercase tracking-wider">Seguimientos hoy</span>
            </div>
          ...
          {followupsHoy.length > 3 && (
            <Link href="/calendar" className="block text-center text-amber-400 text-xs mt-2">Ver {followupsHoy.length - 3} mas →</Link>
          )}
        </div>
        ...
        <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-4 mb-4">
          <div className="flex items-center justify-between mb-3">
            <div className="flex items-center gap-2">
              <span className="text-lg">🟢</span>
              <span className="text-green-300 font-black text-sm uppercase tracking-wider">Clientes activos</span>
            </div>
