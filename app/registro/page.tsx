  ...
  if (exito) return (
    <div className="min-h-screen bg-[#050505] text-white font-sans flex items-center justify-center p-6">
      <div className="w-full max-w-sm text-center">
        <div className="text-[#d4af37] text-4xl font-bold tracking-tighter uppercase italic mb-8">Homvi</div>
    ...
    <div className="min-h-screen bg-[#050505] text-white font-sans flex items-center justify-center p-6">
      <div className="w-full max-w-sm">
        ...
        <div className="bg-[#0a0a0a] border border-white/10 rounded-[2rem] p-8">
          ...
          <p className="text-gray-400 text-sm mb-8">Regístrate para acceder a Homvi</p>
