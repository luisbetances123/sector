      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2">
            <h2 className="text-xs font-bold uppercase tracking-widest text-amber-500 mb-4">Próximas Citas</h2>
          ...
          <div>
            <h2 className="text-xs font-bold uppercase tracking-widest text-zinc-500 mb-4">Notas Rápidas</h2>
            <div className="space-y-3">
              {notas.map((nota) => (
