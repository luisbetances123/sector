  ...
  return (
    <nav className="md:hidden fixed bottom-0 left-0 w-full bg-[#050505]/95 backdrop-blur-xl border-t border-white/10 z-[100]">
      <div className="flex justify-around items-center px-1 py-2">
        ...
        <Link href="/followups" className={`flex flex-col items-center gap-1 px-2 py-1.5 rounded-xl transition-all ${pathname === '/followups' ? 'text-amber-500' : 'text-gray-500'}`}>
          <div className="relative">
            <svg className={`w-5 h-5 ${notifCount > 0 ? 'text-amber-500' : ''}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
